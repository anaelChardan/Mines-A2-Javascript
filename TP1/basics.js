...
const val = 1 * 2.12 + 3 / 4e3 % 5 + '6';

console.log(val)

//////// -----> Reponse : val vaut "2.1.20756"
...
var xCube = x => x * square(x)

var testXCube = xCube(3)
...
var coucou = compose(square, fibo)(8) == square(fibo(8));
...
function accum(fun, n) {
  return (new Array(n)).fill(0).map( (val, i) => fun(i))
}

var resAccum = accum(compose(square, fibo), 10);
var plop = null
// ## {{{O}{{b}}}{j}{{e,t}{s}}}
...
var resSetFact = heroes.getFact('Batman', 'likes') == 'Joker';
var plop
// ## Bonus
